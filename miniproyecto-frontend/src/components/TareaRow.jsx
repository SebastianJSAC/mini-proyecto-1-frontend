...
export const TareaRow = ({ tarea, nivel = 0, onEliminar, setTareas, API_URL }) => {
        ...
        <Fragment>
            ...
            {mostrarInput && (
                <tr>
                    <td
                        colSpan="3"
                        className="p-2 bg-blue-50/30"
                        style={{ paddingLeft: `${(nivel + 1) * 20 + 16}px` }}
                    >
